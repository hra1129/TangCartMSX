...
sp2_32plane::
	...
	attribute:		;     Y      X        Pattern Color + EC
			...
			db		 32 * 0,40 * 1 + 50,   4 + 32, 0
			db		 32 * 0,40 * 2 + 50,   8 + 32, 0
			db		 32 * 0,40 * 3 + 50,  12 + 32, 0
			db		 32 * 1,40 * 0 + 50,  16 + 32, 0
			db		 32 * 1,40 * 1 + 50,  20 + 32, 0
			db		 32 * 1,40 * 2 + 50,  24 + 32, 0
			db		 32 * 1,40 * 3 + 50,  28 + 32, 0
			db		 32 * 2,40 * 0 + 50,  32 + 32, 0
			db		 32 * 2,40 * 1 + 50,  36 + 32, 0
			db		 32 * 2,40 * 2 + 50,  40 + 32, 0
			db		 32 * 2,40 * 3 + 50,  44 + 32, 0
			db		 32 * 3,40 * 0 + 50,  48 + 32, 0
			db		 32 * 3,40 * 1 + 50,  52 + 32, 0
			db		 32 * 3,40 * 2 + 50,  56 + 32, 0
			db		 32 * 3,40 * 3 + 50,  60 + 32, 0
			db		 32 * 4,40 * 0 + 50,  64 + 32, 0
			db		 32 * 4,40 * 1 + 50,  68 + 32, 0
			db		 32 * 4,40 * 2 + 50,  72 + 32, 0
			db		 32 * 4,40 * 3 + 50,  76 + 32, 0
			db		 32 * 5,40 * 0 + 50,  80 + 32, 0
			db		 32 * 5,40 * 1 + 50,  84 + 32, 0
			db		 32 * 5,40 * 2 + 50,  88 + 32, 0
			db		 32 * 5,40 * 3 + 50,  92 + 32, 0
			db		 32 * 6,40 * 0 + 50,  96 + 32, 0
			db		 32 * 6,40 * 1 + 50, 100 + 32, 0
			db		 32 * 6,40 * 2 + 50, 104 + 32, 0
			db		 32 * 6,40 * 3 + 50, 108 + 32, 0
			db		 32 * 7,40 * 0 + 50, 112 + 32, 0
			db		 32 * 7,40 * 1 + 50, 116 + 32, 0
			db		 32 * 7,40 * 2 + 50, 120 + 32, 0
			db		 32 * 7,40 * 3 + 50, 124 + 32, 0
	color_data:
			db		  0
			db		  1
			db		  2
