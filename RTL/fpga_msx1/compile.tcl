#	Tangnano20k_step8 compile script
# =============================================================================
#	2024/12/15 t.hara
#

puts "Run compile Tangnano20k_step8"
...
add_file src/tangnano20k_step8.v
...
# =============================================================================
add_file src/tangnano20k_step8.cst
...
# =============================================================================
set_option -top_module tangnano20k_step8
set_option -gen_io_cst 1
set_option -output_base_name tangnano20k_step8
