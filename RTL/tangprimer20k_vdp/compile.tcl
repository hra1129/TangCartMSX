#	Tangprimer20k_vdp compile script
# =============================================================================
#	2024/12/15 t.hara
#

puts "Run compile Tangprimer20k_vdp"
...
add_file src/tangprimer20k_vdp.v
...
# =============================================================================
add_file src/tangprimer20k_vdp.cst
...
# =============================================================================
set_option -top_module tangprimer20k_vdp
set_option -gen_io_cst 1
set_option -output_base_name tangprimer20k_vdp
